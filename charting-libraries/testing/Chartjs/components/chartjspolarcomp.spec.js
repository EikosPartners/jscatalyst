import Component from '@/components/visualizations/Chartjs/ChartjsPolarComp'
...
describe('Chartjs Polar Component light theme', () => {
    let wrapper
    beforeEach(() => {
...
describe('Chartjs Polar Component dark theme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
describe('Chartjs Polar Component different colorTheme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
// describe('Chartjs Polar Comp, snapshot', ()=>{
//     let wrapper
