...
describe('Chartjs Line Component light theme', () => {
    let wrapper
    beforeEach(() => {
...
describe('Chartjs Line Component dark theme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
describe('Chartjs Line Component different colorTheme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
describe('Chartjs Line Comp, snapshot', ()=>{
    let wrapper
