import Component from '@/components/Visualizations/Chartjs/ChartjsBubbleComp'
...
describe('Chartjs Bubble Component light theme', () => {
    let wrapper
    beforeEach(() => {
...
describe('Chartjs Bubble Component dark theme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
describe('Chartjs Bubble Component different colorTheme', () => {
    let wrapper
    beforeEach(() => {
      store = new Vuex.Store({
        state: {
...
describe('Chartjs Bubble Comp, snapshot', ()=>{
    let wrapper
